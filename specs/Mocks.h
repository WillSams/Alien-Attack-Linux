...
public:
  MOCK_METHOD7(addPlayerBullet,
               void(int x, int y, int width, int height, std::string textureID,
...
TextureHolder& textures)); MOCK_CONST_METHOD5(createProjectile, void(SceneNode&
node, Projectile::Type type, float xOffset, float yOffset, const TextureHolder&
textures)); MOCK_CONST_METHOD2(createPickup, void(SceneNode& node, const
