...
//   MOCK_CONST_METHOD0(getTextureID, std::string());
//   MOCK_CONST_METHOD0(getNumFrames, int());
//   MOCK_CONST_METHOD0(getCallbackID, int());
//   MOCK_CONST_METHOD0(getAnimSpeed, int());
// };
...
// public:
//   MOCK_METHOD7(addPlayerBullet,
//                void(int x, int y, int width, int height, std::string
//                textureID,
//                     int numFrames, Vector2D heading));
//   MOCK_METHOD7(addEnemyBullet,
//                void(int x, int y, int width, int height, std::string
//                textureID,
//                     int numFrames, Vector2D heading));
...
//         MOCK_CONST_METHOD2(drawCurrent, void(sf::RenderTarget& target,
// sf::RenderStates states)); MOCK_METHOD2(updateCurrent, void(sf::Time dt,
// CommandQueue& commands)); MOCK_CONST_METHOD0(isAllied, float());
...
//         MOCK_METHOD2(playLocalSound, void(CommandQueue& commands,
// SoundEffect::ID effect)); MOCK_METHOD0(getIdentifier, int());
...
//         MOCK_METHOD2(checkProjectileLaunch, void(sf::Time dt, CommandQueue&
// commands);

//         MOCK_CONST_METHOD2(createBullets, void(SceneNode& node, const
// TextureHolder& textures)); MOCK_CONST_METHOD5(createProjectile,
// void(SceneNode& node, Projectile::Type type, float xOffset, float yOffset,
// const TextureHolder& textures)); MOCK_CONST_METHOD2(createPickup,
// void(SceneNode& node, const TextureHolder& textures));
